...
def get_nutrition(food_type, portion):
    ...
    food_db = {
        ...
        "banana": {
            ...
            "micros": {"vitamin_c": "10.3mg", "potassium": "422mg"}
        },
        "pizza": {
            "calories": 285,
            "macros": {"carbs": 36, "protein": 12, "fat": 10},
            "micros": {"calcium": "189mg", "iron": "2.5mg"}
        },
        "hotdog": {
            "calories": 151,
            "macros": {"carbs": 2, "protein": 5, "fat": 13},
            "micros": {"sodium": "567mg", "iron": "0.8mg"}
        },
        "hamburger": {
            "calories": 250,
            "macros": {"carbs": 31, "protein": 12, "fat": 9},
            "micros": {"iron": "2.2mg", "potassium": "270mg"}
        },
        "ice cream": {
            "calories": 137,
            "macros": {"carbs": 16, "protein": 2.3, "fat": 7.3},
            "micros": {"calcium": "84mg", "vitamin_a": "278IU"}
        },
        "carrot": {
            "calories": 25,
            "macros": {"carbs": 6, "protein": 0.6, "fat": 0.1},
            "micros": {"vitamin_a": "835mcg", "potassium": "195mg"}
        },
        "broccoli": {
            "calories": 55,
            "macros": {"carbs": 11, "protein": 3.7, "fat": 0.6},
            "micros": {"vitamin_c": "89mg", "calcium": "47mg"}
        },
        "orange": {
            "calories": 62,
            "macros": {"carbs": 15.4, "protein": 1.2, "fat": 0.2},
            "micros": {"vitamin_c": "70mg", "potassium": "237mg"}
        },
        "strawberry": {
            "calories": 4,
            "macros": {"carbs": 0.9, "protein": 0.1, "fat": 0.0},
            "micros": {"vitamin_c": "7mg", "potassium": "18mg"}
        }
    }
